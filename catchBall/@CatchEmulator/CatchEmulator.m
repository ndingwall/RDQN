classdef CatchEmulator < AbstractEmulator
    ...
    methods
        function [o,r,f] = start(this, H, W, prob)
            ...
            this.prob = prob;
            this.loc = W+1;
            this.b_loc = [1; randi(2*W+1)];
            this.b_dir = randi(2)*2 - 3;
        ...
        function [o,r,f] = act(this,action)
            ...
            this.b_loc(1) = this.b_loc(1) + 2;
            this.b_loc(2) = this.b_loc(2) + 2 * this.b_dir;
            if this.b_loc(2) < 2
                this.b_dir = 1;
        ...
        function [o,r,f] = forceStart(this, H, W, prob, dir, loc)
            % dir should be +/- 1
