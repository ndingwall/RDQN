function [history, games, bnecks, frames] = followVarTManPolicy(dqn, w, epsilon, nNewTrans, gmInfo, prob)
    ...
    for i=1:N
        ...
        if randstart
            %%
            gm.condframe(1,1) = randi(5,1) - 3; % Vertical (-2,...,2)
            gm.condframe(2,1) = randi(3,1) - 2; % Horizontal (-1,0,1) 
        end
